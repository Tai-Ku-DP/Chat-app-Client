...
// Hàm useStores() trả về IRootStore (store của bạn), và bất kỳ component nào gọi hàm này sẽ nhận được cùng một instance của rootStore mà bạn đã truyền vào RootStoreProvider
